...
Component_ModL::Component_ModL(ObserverAudioProcessor& p, juce::Slider::Listener* listener, juce::Button::Listener* blistener) :
	audioProcessor(p),
	...
	modDestKnob(ImageCache::getFromMemory(BinaryData::modDestLStrip_png, BinaryData::modDestLStrip_pngSize), nOfModulationDestinations, false, "", 3, 1.0, juce::Slider::SliderStyle::RotaryVerticalDrag),
	...
	retrigger()
{
	...
	amtKnob.setBoundsRelative(0.0f, 0.38104089f, 0.18478261f, 0.252788104f);
	...
	veloKnob.setBoundsRelative(0.057065217f, 0.747211896f, 0.18478261f, 0.252788104f);
	...
	softKnob.setBoundsRelative(0.39673913f, 0.747211896f, 0.18478261f, 0.252788104f);
	...
	speedKnob.setBoundsRelative(0.73777174f, 0.747211896f, 0.18478261f, 0.252788104f);
	...
	modDestKnob.setBoundsRelative(0.2934783f, 0.0f, 0.7065217f, 0.2527881f);
	modDestKnob.setRange(0, nOfModulationDestinations - 1, 0);

	aSlider.addListener(listener);
	Component::addAndMakeVisible(aSlider);
	aSlider.setBoundsRelative(0.1875f, 0.2695167f, 0.149456422f, 0.4163569f);
	...
	dSlider.setBoundsRelative(0.3369565f, 0.2695167f, 0.149456422f, 0.4163569f);
	...
	sSlider.setBoundsRelative(0.4864130f, 0.2695167f, 0.149456422f, 0.4163569f);
	...
	rSlider.setBoundsRelative(0.635869565f, 0.2695167f, 0.149456422f, 0.4163569f);
	...
	retrigger.setBoundsRelative(0.80298913f, 0.35873606f, 0.149456522f, 0.20632f);
	//=====
}

Component_ModL::~Component_ModL() {
}

void Component_ModL::paint(juce::Graphics& g) {
}

void Component_ModL::resized() {
	amtKnob.setBoundsRelative(0.0f, 0.38104089f, 0.18478261f, 0.252788104f);
	veloKnob.setBoundsRelative(0.057065217f, 0.747211896f, 0.18478261f, 0.252788104f);
	softKnob.setBoundsRelative(0.39673913f, 0.747211896f, 0.18478261f, 0.252788104f);
	speedKnob.setBoundsRelative(0.73777174f, 0.747211896f, 0.18478261f, 0.252788104f);
...
void Component_ModL::connectToTreestate(String prepend) {
