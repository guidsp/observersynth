...
class Component_ModR : public juce::Component
{
public:
	Component_ModR(ObserverAudioProcessor&, juce::Slider::Listener* listener, juce::Button::Listener* blistener);
	~Component_ModR() override;
